...
class Conversion {
    ...
    func getCurrencies(then closure: @escaping ([String]?, Error?) -> Void){
        ...
        //  We add arguments to the request
        let key = "QIR5DaLBMe5FYWzWpHVFUCqmJ0FEeKSM"
    ...
    func convert(amount: String, from: String, to: String, then closure: @escaping (Double?, Error?) -> Void){
        ...
        let rawUrl = "https://api.apilayer.com/fixer/convert"
        ...
        urlComponent?.queryItems = [
            ...
            URLQueryItem(name: "apikey", value: "QIR5DaLBMe5FYWzWpHVFUCqmJ0FEeKSM")
        ]
